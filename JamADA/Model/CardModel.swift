...
class CardModel {
  ...
  func loadCards() {
    ...
    let weddingCards = CardData(theme: "Casamento", icon: "heart.fill", cards: ["Padre", "Noivo", "Noiva", "Padrinho", "Dama de honra", "Amante"])
    ...
    let soccerCards = CardData(theme: "Partida de Futebol", icon: "soccerball.inverse", cards: ["Torcedor fanático", "Goleiro", "Juiz", "Gandula", "Jogador no chão", "Jogador correndo"])
